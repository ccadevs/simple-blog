...
<div class="container bg-white pt-5">
    <?php while ($row = $blogPosts->fetch(PDO::FETCH_ASSOC)): ?>
        <div class="row blog-item px-3 pb-5">
            <div class="col-md-5">
                <img class="img-fluid mb-4 mb-md-0" src="./public/img/uploads/<?php echo htmlspecialchars($row['image']); ?>" alt="Image">
            </div>
            <div class="col-md-7">
                ...
                <a class="btn btn-link p-0" href="/blog/<?php echo htmlspecialchars($row['slug']); ?>">Pročitajte više... <i class="fa fa-angle-right"></i></a>
            </div>
        </div>
    <?php endwhile; ?>
</div>
