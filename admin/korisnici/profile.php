<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if ($userModel->updateUser()) {
            $successMessage = "Podaci su uspešno ažurirani.";
            $user = $userModel->findUserById($_SESSION['user_id']);
        } else {
...
<head>
    ...
    <title>PZAgency - Ažuriranje profila</title>
                                    ...
                                    <form method='post' enctype="multipart/form-data">
                                        <div class="row">
                                            ...
                                            <div class="col-xs-12 col-sm-12 col-md-12 text-right">
                                                <button type="submit" class="btn btn-primary" name="submit">Ažurirajte nalog</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
