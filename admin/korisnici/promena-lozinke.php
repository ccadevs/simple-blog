<?php
    ...
    $user = $userModel->findUserById($userModel->id);
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if ($userModel->verifyPassword($currentPassword)) {
            if ($newPassword === $confirmPassword) {
                if ($userModel->updatePassword($newPassword)) {
                    $successMessage = "Lozinka je uspešno ažurirana.";
                } else {
                    $errorMessage = "Došlo je do greške prilikom ažuriranja lozinke.";
                }
            } else {
                $errorMessage = "Nova lozinka i potvrda lozinke se ne podudaraju.";
            }
        } else {
...
<head>
    ...
    <title>PZAgency - Ažuriranje lozinke</title>
            ...
            <li class="nav-item">
                ...
                <div class="collapse" data-parent="#accordionSidebar" id="collapseObjekti">
                    <div class="bg-white py-2 collapse-inner rounded">
                        <a class="collapse-item" href="../blog/">Sve novosti</a>
                        <a class="collapse-item" href="../blog/dodaj-blog">Dodajte novost</a>
                        <h6 class="collapse-header">Kategorije</h6>
                        <a class="collapse-item" href="../blog/kategorije">Sve kategorije</a>
                        <a class="collapse-item" href="../blog/dodaj-kategoriju">Dodajte kategoriju</a>
                    </div>
                </div>
            </li>
            <li class="nav-item">
			...
			<div id="content">
                ...
                <div class="container-fluid">
                    <div class="card shadow mb-4">
                        <div class="card-body">
                            <a class="btn btn-primary btn-back" href="../dashboard">Nazad</a>
                                        ...
                                        <div class="row">
                                            <div class="col-xs-12 col-sm-12 col-md-12">
                                                <div class="form-group">
                                                    ...
                                                    <input class="form-control" name="password" type="password" required placeholder="Enter your current password" id="password">
                                                </div>
                                            </div>
                                            <div class="col-xs-12 col-sm-12 col-md-12">
                                                <div class="form-group">
                                                    <strong>Nova lozinka</strong> 
                                                    <input class="form-control" name="newpassword" type="password" required placeholder="Nova lozinka" id="newpassword">
                                                </div>
                                            </div>
                                            <div class="col-xs-12 col-sm-12 col-md-12">
                                                <div class="form-group">
                                                    <strong>Potvrdite novu lozinku</strong> 
                                                    <input class="form-control" name="confirmpassword" type="password" required placeholder="Potvrdite novu lozinku" id="confirmpassword">
                                                </div>
                                            </div>
                                            <div class="col-xs-12 col-sm-12 col-md-12 text-right">
                                                <button type="submit" class="btn btn-primary" name="submit">Ažurirajte lozinku</button>
                                            </div>
                                        </div>
                                    </form>
                                </div>
