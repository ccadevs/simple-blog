<?php
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if ($blogPostModel->create()) {
            ...
            $errorMessage = "Došlo je do greške prilikom kreiranja objave.";
        }
    }
...
<head>
    ...
    <title>PZAgency - Dodaj objavu</title>
        ...
        <div class="d-flex flex-column" id="content-wrapper">
			<div id="content">
                ...
                <div class="container-fluid">
                    <a class="btn btn-primary btn-back" href="./">Sve objave</a>
                                ...
                                <div class="col-md-12">
                                    <form method='post' enctype="multipart/form-data">
                                        ...
                                        <div class="col-xs-12 col-sm-12 col-md-12 text-right">
                                            <button type="submit" class="btn btn-primary" name="submit">Objavite</button>
                                        </div>
                                    </form>
                                </div>
                            </div>
