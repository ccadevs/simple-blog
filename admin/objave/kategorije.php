    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        if (isset($_POST['update'])) {
            ...
            if ($categoryModel->update()) {
                $successMessage = "Kategorija je uspešno ažurirana.";
            } else {
                $errorMessage = "Došlo je do greške prilikom ažuriranja kategorije.";
            }
            ...
            if ($categoryModel->delete()) {
                ...
                $errorMessage = "Došlo je do greške prilikom brisanja kategorije.";
            }
        }
    }
...
<body id="page-top">
        ...
        <div class="d-flex flex-column" id="content-wrapper">
			<div id="content">
                ...
                <div class="container-fluid">
                    <a class="btn btn-primary btn-back" href="./dodaj-kategoriju">Dodajte kategoriju</a>
                                    ...
                                    <tbody>
                                        <?php while ($row = $categories->fetch(PDO::FETCH_ASSOC)): ?>
                                            <tr>
                                                ...
                                                <td>
                                                    <button type="button" class="btn btn-primary btn-sm edit-btn" data-id="<?php echo $row['id']; ?>" data-name="<?php echo $row['name']; ?>" data-toggle="modal" data-target="#editModal">
    ...
    <div class="modal fade" id="editModal" tabindex="-1" role="dialog" aria-labelledby="editModalLabel" aria-hidden="true">
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="editModalLabel">Izmeni kategoriju</h5>
